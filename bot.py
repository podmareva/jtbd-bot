...
WELCOME = (
    ...
    "✅ Просто нажми «СОГЛАСЕН/СОГЛАСНА», чтобы начать."
)
...
async def get_feedback(text):
    prompt = (
        f"Ответ участника:\n\"{text}\"\n\n"
        "Ответь коротко, по-доброму, как внимательный собеседник.\n"
        "Если ответ неубедительный, поверхностный или неполный — аккуратно подскажи, как его улучшить.\n"
        "Если ответ сильный — поддержи и подметь, что именно в нём хорошо. Без фальши, без клише и шаблонов."
    )
    try:
...
async def callback_handler(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    "💬 Отвечай на вопросы как можно подробнее — это поможет собрать для тебя точную и полезную распаковку!\n\n"
