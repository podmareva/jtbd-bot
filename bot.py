...
async def get_feedback(text):
    prompt = (
        f"Ответ участника:\n\"{text}\"\n\n"
        "Дай короткий, но честный фидбэк как тёплый и искренний коуч.\n"
        "Если ответ слабый, неполный или шаблонный — аккуратно подсвети, как можно улучшить.\n"
        "Если сильный — поддержи и покажи, что в нём хорошо. Без фальши и шаблонных фраз."
    )
    try:
